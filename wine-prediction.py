...
conf = pyspark.SparkConf().setAppName('quality').setMaster('local')
...
#save training model
RFmodel.save(sc, 's3://s3-for-emr-cluster02/spark_ml_model')
#RFmodel.save(sc, '/Users/aliahmat/Documents/python-code/spark_ml_model')
